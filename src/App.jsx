        ...
        <div className="db-footer-cols">
          ...
          <div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {[
                { label:"Sessions",  action: ()=>{ const el=document.getElementById("sessions"); if(showLanding && el){ el.scrollIntoView({behavior:"smooth"}); } else { sessionStorage.setItem("showLanding","1"); sessionStorage.setItem("page","dashboard"); sessionStorage.setItem("landingScroll","sessions"); window.location.href=window.location.origin; } } },
                { label:"Speakers",  action: ()=>{ const el=document.getElementById("instructors"); if(showLanding && el){ el.scrollIntoView({behavior:"smooth"}); } else { sessionStorage.setItem("showLanding","1"); sessionStorage.setItem("page","dashboard"); sessionStorage.setItem("landingScroll","instructors"); window.location.href=window.location.origin; } } },
                { label:"FAQ",       action: ()=>{ const el=document.getElementById("faq-v2"); if(showLanding && el){ el.scrollIntoView({behavior:"smooth"}); } else { sessionStorage.setItem("showLanding","1"); sessionStorage.setItem("page","dashboard"); sessionStorage.setItem("landingScroll","faq-v2"); window.location.href=window.location.origin; } } },
          ...
          <div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              {[
                { label:"Facebook",  href:"https://www.facebook.com/groups/1337078366829371", svg:"M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.235 2.686.235v2.97h-1.513c-1.491 0-1.956.93-1.956 1.886v2.267h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" },
                { label:"Instagram", href:"https://www.instagram.com/spedsummit/", svg:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" },
                { label:"YouTube",   href:"https://www.youtube.com/@SPEDSummit", svg:"M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.96-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z" },
              ].map(({ label, href, svg }) => (
      ...
      <div style={{ width:248, flexShrink:0, display:"flex", flexDirection:"column", gap:14 }}>
        ...
        <div className="db-card db-sidebar-card" style={{ padding:"20px 18px" }}>
          ...
          {[
            ...
            { icon:"timer",       label:"PD Hours Learned",       val: hoursLearned,      color:C.success  },
          ].map((row, i, arr) => (
    ...
    <div style={{ minHeight:"100%", background:C.gray50, width:"100%" }}>
      <style>{CSS + `
        ...
        @media(max-width:600px){
          ...
          .db-continue-list { display:flex !important; flex-direction:row !important; overflow-x:scroll !important; overflow-y:hidden !important; gap:12px !important; padding-top:0 !important; padding-bottom:8px !important; padding-left:16px !important; padding-right:16px !important; margin-left:-16px !important; margin-right:-16px !important; -webkit-overflow-scrolling:touch; scroll-snap-type:x mandatory; scroll-padding-left:16px; touch-action:pan-x pan-y; overscroll-behavior-x:contain; }
            ...
            <>
              ...
              {(sessionsLoading || filteredInProgress.length > 0) && <div style={{ marginBottom:32 }}>
                ...
                {sessionsLoading ? (
                  ...
                  <div className="db-continue-list" style={isMobile ? { display:"flex", flexDirection:"row", overflowX:"scroll", overflowY:"hidden", gap:12, paddingLeft:16, paddingRight:16, paddingBottom:8, marginLeft:-16, marginRight:-16, WebkitOverflowScrolling:"touch", scrollSnapType:"x mandatory", scrollPaddingLeft:16, touchAction:"pan-x pan-y", overscrollBehaviorX:"contain", msOverflowStyle:"none", scrollbarWidth:"none" } : { display:"flex", flexDirection:"column", gap:12 }}>
          ...
          {hasStarted && (
            <div style={{ display:"flex", gap:12, flexShrink:0 }}>
              {[
                ...
                { val:hoursLearned, label:"PD Hours Learned" },
              ].map((stat,i) => (
    ...
    return (
      <div style={{ display:"flex", alignItems:"center", justifyContent:"center",
        ...
        <div style={{ maxWidth:480, width:"100%", textAlign:"center" }}>
          ...
          {passed ? (
            <button onClick={()=> onCertificateClick ? onCertificateClick(session) : downloadCertificate({ recipientName:adminName, sessionTitle:session.title, instructor:session.instructor, duration:session.duration, score, description:session.certDescription||"" })}
...
function detectFileType(url, contentType) {
  ...
  if (ct.includes("spreadsheetml") || ct.includes("excel") || ext === "xlsx" || ext === "xls") return "XLSX";
  ...
  if (ct.includes("zip") || ct.includes("x-zip") || ext === "zip") return "ZIP";
  if (ct.includes("video") || ["mp4","mov","avi","mkv","webm"].includes(ext)) return "VIDEO";
  if (ct.includes("audio") || ["mp3","wav","m4a","ogg"].includes(ext)) return "AUDIO";
  if (ct.includes("text/plain") || ext === "txt") return "TXT";
  if (ct.includes("text/csv") || ext === "csv") return "CSV";
  return null;
}
function typeColorFor(t) {
  if (t==="PDF")   return { bg:"#fef2f2", color:"#dc2626" };
  if (t==="DOCX")  return { bg:"#eff6ff", color:"#2563eb" };
  if (t==="PPTX")  return { bg:"#fff7ed", color:"#ea580c" };
  if (t==="XLSX")  return { bg:"#f0fdf4", color:"#16a34a" };
  if (t==="ZIP")   return { bg:"#f5f3ff", color:"#7c3aed" };
  if (t==="VIDEO") return { bg:"#fdf4ff", color:"#9333ea" };
  if (["JPEG","PNG","GIF","WEBP","SVG"].includes(t)) return { bg:"#fef9c3", color:"#a16207" };
  return { bg:"#eff6ff", color:"#6490E8" };
}
function MaterialFileMeta({ fileUrl }) {
  const [size, setSize] = React.useState(null);
  const [detectedType, setDetectedType] = React.useState(() => detectFileType(fileUrl, ""));
  React.useEffect(() => {
    if (!fileUrl) return;
    fetch(fileUrl, { method:"HEAD" }).then(r => {
      ...
      const t = detectFileType(fileUrl, ct);
      if (t) setDetectedType(t);
    }).catch(()=>{});
  }, [fileUrl]);
  const label = detectedType || "FILE";
  const tc = typeColorFor(label);
    ...
    <div ref={containerRef} style={{ background:"#f5f5f5", fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,sans-serif", overflowX:"hidden", width:"100%" }}>
      <style>{`
        ...
        @media(max-width:767px){
          ...
          .sd-video-panel { padding:0 !important; height:auto !important; overflow:hidden !important; width:100% !important; box-sizing:border-box !important; }
      ...
      <div className="sd-mobile-tabs" style={{ background:C.white, borderBottom:`1px solid ${C.gray200}`, overflowX:"auto", WebkitOverflowScrolling:"touch", scrollbarWidth:"none", msOverflowStyle:"none", gap:0 }}>
        ...
        {session.lessons.filter(l => !(l.type === "quiz" && getSessionQuestions(session).length === 0)).map((l, i) => {
          ...
          const isActive = isQuiz ? panelMode === "assessment" : isMaterial ? (i === activeLesson && panelMode === "material") : (i === activeLesson && panelMode === "video");
                    ...
                    return (
                      <div key={String(mat.id || idx)} style={{ display:"flex", alignItems:"center", gap:12, padding:"12px 14px", background:C.white, border:`1px solid ${C.gray200}`, borderRadius:12, flexWrap: isMob ? "wrap" : "nowrap" }}>
                        ...
                        <div style={{ flex:1, minWidth:0 }}>
                          ...
                          {fileUrl ? <MaterialFileMeta fileUrl={fileUrl}/> : <div style={{ fontSize:11, color:C.gray400, marginTop:2 }}>No file</div>}
                        </div>
                        {fileUrl && (
                          <button
                            ...
                            style={{ flexShrink:0, display:"inline-flex", alignItems:"center", justifyContent:"center", gap:6, padding:"8px 18px", borderRadius:8, background:C.primary, color:"#fff", fontSize:13, fontWeight:700, cursor:"pointer", border:"none", fontFamily:"inherit", ...(isMob ? { width:"100%", marginTop:4 } : {}) }}>
        ...
        {bottomTab === "community" && (
          <div className="sd-community-wrap" style={{ padding:0, minHeight:400 }}>
            <div className="sd-community-inner" style={{ padding:"20px 24px" }}>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"34px 1fr", gap:"0 10px" }}>
                    ...
                    {rs.open && ([
                      <div key="sd-compose-avatar" style={{ display:"flex", flexDirection:"column", alignItems:"center", paddingTop:8 }}>
                        <Avatar name={adminName||"You"} src={adminAvatar} size={34}/>
                      </div>,
              ...
              {/* Report modal */}
              {sdReportModal && (
                <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.45)", zIndex:9999, display:"flex", alignItems:"center", justifyContent:"center", padding:16 }} onClick={()=>setSdReportModal(null)}>
                  <div style={{ background:"#fff", borderRadius:16, padding:"28px 24px 20px", width:"100%", maxWidth:400, boxShadow:"0 24px 60px rgba(0,0,0,0.2)" }} onClick={e=>e.stopPropagation()}>
                    {sdReportDone ? (<>
                      <div style={{ textAlign:"center", padding:"12px 0 8px" }}>
                        <Icon name="check-circle" size={48} color="#10b981"/>
                        <div style={{ fontWeight:800, fontSize:18, color:C.gray900, marginTop:12, marginBottom:8 }}>Report submitted</div>
                        <p style={{ margin:"0 0 24px", fontSize:14, color:C.gray500, lineHeight:1.6 }}>Thanks for letting us know. We'll review this comment.</p>
                        <button onClick={()=>setSdReportModal(null)} style={{ padding:"10px 28px", borderRadius:10, border:"none", background:C.primary, fontSize:14, fontWeight:700, color:"#fff", cursor:"pointer" }}>Done</button>
                      </div>
                    </>) : (<>
                      <div style={{ fontWeight:800, fontSize:18, color:C.gray900, marginBottom:4 }}>Report comment</div>
                      <p style={{ margin:"0 0 18px", fontSize:13, color:C.gray500 }}>Why are you reporting <strong>{sdReportModal.authorName}</strong>'s comment?</p>
                      <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:18 }}>
                        {["Spam or self-promotion","Harassment or bullying","Hate speech or discrimination","Misinformation","Inappropriate content","Other"].map(reason=>(
                          <label key={reason} style={{ display:"flex", alignItems:"center", gap:10, cursor:"pointer", padding:"10px 12px", borderRadius:10, border:`1.5px solid ${sdReportReason===reason?C.primary:C.gray200}`, background:sdReportReason===reason?"rgba(100,144,232,0.06)":"transparent", transition:"all .12s" }}>
                            <input type="radio" name="sd-report-reason" value={reason} checked={sdReportReason===reason} onChange={()=>setSdReportReason(reason)} style={{ accentColor:C.primary }}/>
                            <span style={{ fontSize:13, color:C.gray800 }}>{reason}</span>
                          </label>
                        ))}
                        {sdReportReason==="Other" && (
                          <textarea value={sdReportOther} onChange={e=>setSdReportOther(e.target.value)} placeholder="Please describe…" rows={3}
                            style={{ width:"100%", padding:"8px 12px", border:`1px solid ${C.gray200}`, borderRadius:8, fontSize:13, color:C.gray700, outline:"none", resize:"none", fontFamily:"inherit", boxSizing:"border-box" }}/>
                        )}
                      </div>
                      <div style={{ display:"flex", justifyContent:"flex-end", gap:10 }}>
                        <button onClick={()=>setSdReportModal(null)} style={{ padding:"9px 20px", borderRadius:10, border:`1px solid ${C.gray200}`, background:C.white, fontSize:14, fontWeight:600, color:C.gray700, cursor:"pointer" }}>Cancel</button>
                        <button disabled={!sdReportReason||(sdReportReason==="Other"&&!sdReportOther.trim())||sdReportSubmitting}
                          onClick={async ()=>{ setSdReportSubmitting(true); await new Promise(r=>setTimeout(r,800)); setSdReportSubmitting(false); setSdReportDone(true); }}
                          style={{ padding:"9px 20px", borderRadius:10, border:"none", background:sdReportReason&&!(sdReportReason==="Other"&&!sdReportOther.trim())?C.primary:C.gray200, fontSize:14, fontWeight:700, color:"#fff", cursor:"pointer" }}>
                          {sdReportSubmitting?"Submitting…":"Submit Report"}
                        </button>
                      </div>
                    </>)}
                  </div>
...
function CommunityPage({ toast, userName = "", userAvatar = null, sessions = [], refreshKey = 0, currentUserId = null }) {
  ...
  async function submitReply(parentId, sessionId, sessionTitle) {
    const rs = replyState[parentId] || {};
    if (!rs.body?.trim()) return;
    const body = rs.body.trim();
    const tempId = "tmp-reply-" + Date.now();
    ...
    return (
      <div key={c.id} className="comm-comment-pad" style={{ background:C.white, borderRadius:14, border:`1px solid ${C.gray200}`, marginBottom:10, padding:"16px 18px 12px" }}>
        ...
        <div className="comm-thread-grid" style={{ display:"grid", gridTemplateColumns:"34px 1fr", gap:"0 10px" }}>
            ...
            <div style={{ marginBottom:4 }}>
              <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                ...
                <button onClick={()=>setMenuOpen(menuOpen===c.id?null:c.id)}
                  style={{ background:"none", border:"none", cursor:"pointer", padding:"2px 4px", borderRadius:6, color:C.gray400, lineHeight:1, display:"flex", alignItems:"center" }}
                  ...
                  <Icon name="dots-three" size={20} weight="bold"/>
                </button>
                {menuOpen===c.id && (
          ...
          {/* ── Reply rows: each reply gets its own grid row, left=avatar+line, right=content ── */}
          {replies.map((r, ri) => {
            const isLast = ri === replies.length - 1 && !rs.open;
            return ([
              <div key={`rl-${r.id}`} style={{ display:"flex", flexDirection:"column", alignItems:"center", paddingTop:8 }}>
  ...
  return (
    <div style={{ minHeight:"100vh", fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,sans-serif", background:T.bg, overflowX:"clip", color:T.text }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media(max-width:767px){
          ...
          .lp-stat-cards > *:last-child { grid-column:1 / -1 !important; max-width:50% !important; margin:0 auto !important; width:100% !important; }
          ...
          .lp-sessions-grid { grid-template-columns:repeat(2,minmax(0,1fr)) !important; padding:0 !important; gap:12px !important; box-sizing:border-box !important; }
      ...
      {(()=>{
        ...
        return (
          <section className="lp-section-pad" style={{ padding:"64px 24px", borderBottom:`1px solid ${T.border}`, background:T.bg }}>
            <div style={{ maxWidth:1100, margin:"0 auto" }}>
              {/* Header */}
      ...
      <section style={{ padding:"64px 24px", borderBottom:`1px solid ${T.border}`, background:T.bg, textAlign:"center" }}>
        <div style={{ maxWidth:560, margin:"0 auto" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:12, maxWidth:320, margin:"0 auto" }}>
            <a href="https://www.facebook.com/groups/1337078366829371" target="_blank" rel="noopener noreferrer"
              style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"0 20px", height:44, width:"100%", background:"#1877f2", color:"#fff", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", transition:"opacity .12s", textDecoration:"none", boxSizing:"border-box" }}
            ...
            <a href="https://www.instagram.com/spedsummit/" target="_blank" rel="noopener noreferrer"
              style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"0 20px", height:44, width:"100%", background:"linear-gradient(135deg,#e1306c,#f77737)", color:"#fff", borderRadius:10, fontSize:14, fontWeight:600, cursor:"pointer", transition:"opacity .12s", textDecoration:"none", boxSizing:"border-box" }}
              onMouseEnter={e=>e.currentTarget.style.opacity=".88"}
              onMouseLeave={e=>e.currentTarget.style.opacity="1"}>
            ...
            <div>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                {[
                  ...
                  <a key={label} href={href} target="_blank" rel="noopener noreferrer" style={{ display:"inline-flex", alignItems:"center", gap:8, fontSize:14, color:T.muted, textDecoration:"none", transition:"color .12s" }}
                    onMouseEnter={e=>e.currentTarget.style.color=T.text}
...
/* ─────────────────────────────────────────────────────────────────────────────
   CONTACT PAGE
───────────────────────────────────────────────────────────────────────────── */
function ContactPage({ onNavigate, isLoggedIn }) {
  const cards = [
    {
      logo: "/Container.png",
    ...
    <div style={{ minHeight:"100vh", background:"#FEF5EC", fontFamily:"'Inter',-apple-system,sans-serif" }}>
      ...
      <div className="contact-breadcrumb" style={{ background:"#fff", borderBottom:"1px solid #f0f0f0", padding:"10px 32px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto", display:"flex", alignItems:"center", gap:6, fontSize:13, color:"#9ca3af" }}>
          <button onClick={()=>{ if(isLoggedIn){ onNavigate&&onNavigate("dashboard"); } else { sessionStorage.setItem("showLanding","1"); sessionStorage.setItem("page","dashboard"); window.location.href=window.location.origin; } }} style={{ background:"none", border:"none", cursor:"pointer", padding:0, fontSize:13, color:"#6490E8", fontWeight:500, fontFamily:"inherit" }}>Home</button>
          <span>/</span>
...
export default function App() {
  ...
  function renderPage() {
    ...
    if (page==="contact")   return <ContactPage onNavigate={nav} isLoggedIn={!!userId}/>;
