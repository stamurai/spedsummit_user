    ...
    <div style={{ minHeight:"100%", background:C.gray50, width:"100%" }}>
      <style>{CSS + `
        ...
        @media(max-width:600px){
          ...
          .db-continue-list { display:flex !important; flex-direction:row !important; overflow-x:scroll !important; overflow-y:hidden !important; gap:12px !important; padding-top:0 !important; padding-bottom:8px !important; padding-left:0 !important; padding-right:16px !important; margin-left:0 !important; margin-right:0 !important; -webkit-overflow-scrolling:touch; scroll-snap-type:x mandatory; touch-action:pan-x pan-y; overscroll-behavior-x:contain; }
            ...
            <>
              ...
              {(sessionsLoading || filteredInProgress.length > 0) && <div style={{ marginBottom:32 }}>
                ...
                {sessionsLoading ? (
                  ...
                  <div className="db-continue-list" style={isMobile ? { display:"flex", flexDirection:"row", overflowX:"scroll", overflowY:"hidden", gap:12, paddingLeft:0, paddingRight:16, paddingBottom:8, WebkitOverflowScrolling:"touch", scrollSnapType:"x mandatory", touchAction:"pan-x pan-y", overscrollBehaviorX:"contain", msOverflowStyle:"none", scrollbarWidth:"none" } : { display:"flex", flexDirection:"column", gap:12 }}>
