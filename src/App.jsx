...
async function downloadCertificate({ recipientName = "Alex Johnson", sessionTitle, instructor, duration = "", score = null, quizTitle = null }) {
  ...
  el.innerHTML = `
    <div style="width:${W}px;height:${H}px;background:#FEF5EC;font-family:'Segoe UI',Roboto,sans-serif;box-sizing:border-box;padding:64px 80px;display:flex;flex-direction:column;justify-content:space-between;">
                    ...
                    {l.status === "completed" ? (
                      <div style={{ display:"flex", gap:6, flexShrink:0 }}>
                        <button onClick={() => { const certId = `SS-${session.id}-${l.id}`; setShareCert({ certUrl:`spedsummit.com/cert/${certId}`, sessionTitle:l.title }); }}
                          ...
                          <Icon name="share" size={13} color={C.gray500}/> Share
                        </button>
      ...
      <div style={{ background:C.white, borderRadius:16, width:"100%", maxWidth:680,
        ...
        <div style={{ display:"flex", gap:10, padding:"16px 20px", justifyContent:"flex-end" }}>
          ...
          <Btn variant="outline" onClick={() => setShowShare(true)}>
            <Icon name="share" size={14} color={C.primary}/> Share Certificate
          </Btn>
